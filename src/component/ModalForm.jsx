                ...
                <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                    ...
                    <form onSubmit={handleBooking}>
                        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label className="text-gray-700 dark:text-gray-200" >{service_price}</label>
                        ...
                        <div className="flex justify-end mt-6">
                            <button onClick={handleBooking} className="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Purchase</button>
                        </div>
                    </form>
                </section>
            </div>
...
const SignleService = () => {
    ...
    const [startDate, setStartDate] = useState(new Date());
    const { user } = useContext(AuthContext);
    const { _id, service_id, service_name, service_image, service_price, service_provider: { name, provider_email } } = service || {};
                                        ...
                                        <form onSubmit={handleBooking}>
                                            <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    <input id="price" name="price" type="text" value={service_price} className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                                                </div>
                                                <div>
                                                    <h2 className="text-xl font-semibold -mt-6">Special instruction</h2>
                                                    <label className="text-gray-700 dark:text-gray-200">Address</label>
                                                ...
                                                <div>
                                                    <label className="text-gray-700 dark:text-gray-200">Customized Service Plan</label>
                                                    <input id="customizedServicePlan" name="customizedServicePlan" type="text"
                                                        defaultValue='true'
                                                        className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                                                </div>
                                            </div>
