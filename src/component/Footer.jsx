...
const Footer = () => {
    return (
        <div>
            <footer className="bg-sky-300 dark:bg-gray-900">
                <div className="container p-6 mx-auto">
                            ...
                            <div className="px-6">
                                ...
                                <div className="flex mt-6 -mx-2">
                                    <a href="#"
                                        ...
                                        aria-label="Reddit">
                                        <svg className="w-12 h-12 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div>
                        <p className="text-center text-gray-500 dark:text-gray-400">© Home Service 2024 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </div>
